...
from modules.pytube.exceptions import ExtractError, RegexMatchError
from modules.pytube.helpers import cache, regex_search
from modules.pytube.parser import find_object_from_startpoint, throttling_array_split
...
def get_initial_function_name(js: str) -> str:
    ...
    raise RegexMatchError(
        caller="get_initial_function_name2", pattern="multiple"
    )
