...
from modules.pytube3 import request, YouTube
from modules.pytube3.helpers import cache, deprecated, install_proxy, uniqueify
...
class Playlist(Sequence):
    ...
    def __init__(self, url: str, proxies: Optional[Dict[str, str]] = None):
        ...
        self.playlist_url = f"https://www.youtube.com/playlist?list={
            self.playlist_id}"
