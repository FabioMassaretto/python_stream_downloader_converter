...
from modules.pytube3.cipher import Cipher
from modules.pytube3.exceptions import RegexMatchError, HTMLParseError, LiveStreamError
from modules.pytube3.helpers import regex_search
...
def apply_descrambler(stream_data: Dict, key: str) -> None:
    ...
    **Example**:
    ...
    if key == "url_encoded_fmt_stream_map" and not stream_data.get(
        ...
        all_formats = json.loads(stream_data["player_response"])[
            "streamingData"]
